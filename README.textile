...
* restart your Redmine instance (depends on how you host it) @touch tmp/restart.txt@

Finally you *must* configure your SAML settings in @plugins/acnplm_auth_shib/lib/acnplm_auth_shib/user_patch.rb@ and @plugins/acnplm_auth_shib/lib/acnplm_auth_shib/account_controller_patch.rb@.

Finaly you need to configure some minor options for the plugin to work, in "Administration" > "Plugins" > "Configure" on the ACN PLM Authentication plugin line.
