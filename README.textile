...
Note that the plugin is now *only tested with Redmine 2.4.4*:https://github.com/redmine/redmine/releases. 
...
* Folder @redmine@ is the folder that installed Redmine 2.4.4.
...
* Give good values chown and chmod for folders (files and subfolders) @redmine/plugins/@, @redmine/public/plugin_assets@, and files @Gemfile@, @Gemfile.lock@ (and more...)
