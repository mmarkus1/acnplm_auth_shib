...
Add one more column @enterpriseid@ - @VARCHAR@ - @127@ - @Null@ into table @users@, filled in values for this column.
...
* clone this repository in your plugins/ directory ; if you have a doubt you put it at the good level, you can go to your redmine root directoryand check you have a @plugins/acnplm_auth_shib/init.rb@ file
    <pre>Click 'Download ZIP' button, unzip and rename folder from acnplm_auth_shib-master to acnplm_auth_shib, upload folder acnplm_auth_shib to folder redmine/plugins/, change chown -R apache:apache acnplm_auth_shib, chmod 777 for folders, chmod 644 for files</pre>
