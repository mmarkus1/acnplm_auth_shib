...
Add these line into file @/etc/httpd/conf.d/shibd.conf@
<pre>
    @<Location /redmine>@
        @AuthType shibboleth@
        @ShibCompatWith24 On@   
...
Thank you very much "Christian A. Rodriguez":https://github.com/chrodriguez. All credits are yours (errors are mine :D ).
